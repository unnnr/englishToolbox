<div class="editor">
  <form class="editor__form">
    ...
    <div class="editor__body" action="">
      <label class="editor__label text-fourth" for="">Title<small class="editor__counter">0/50</small>
      </label>
      <input class="editor__input input-second" type="text" placeholder="place for your title">
      <label class="editor__label text-fourth" for="">Custom description<small class="editor__counter">0/180</small>
      </label>
