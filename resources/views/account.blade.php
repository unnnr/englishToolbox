    ...
    <div class="management__body">
      <div class="management__account-header">
        ...
        <div class="management__account-wrapper">
          ...
          <button class="management__account-edit-button text-fourth"><span class="material-icons">edit</span>edit account</button>
        </div>
      </div>
      ...
      <div class="management__account-input-group management__account-input-group--margined">
        ...
        <button class="management__account-visibility-button">
          <span class="management__account-input-icon management__account-input-icon--visibility material-icons-round">visibility_off</span>
        </button>
      </div>
      <div class="management__account-input-group">
      ...
      <button class="management__account-delete-button text-fourth"><span class="material-icons">delete_forever</span>delete account</button>
    </div>
  </div>
