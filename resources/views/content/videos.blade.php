...
<section class="selected container">
  <div class="selected__player">
    <div class="selected__rationed">
      <iframe class="selected__video" temp-src="https://www.youtube.com/embed/5qap5aO4i9A" frameborder="0"
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <div class="selected__player-overlay">
        <object class="selected__overlay-image" data="{{ asset("img/svg/player-overlay.svg") }}"
